				      ...
				      int gen)
{
	...
	for (i = 0; i < 7; i++)
	{
	    Reg_R_then_W(pcie_phy, 0x1fa5b794, i << 8, 10, 0 ); //rg_force_da_pxp_cdr_pr_idac[10:0]
				      ...
				      int gen)
{
	...
	for (i = 0; i < 7; i++)
	{
	    Reg_R_then_W(pcie_phy, lane_offset_dig + 0x1fa5b794, i << 8, 10, 0 ); //rg_force_da_pxp_cdr_pr_idac[10:0]
